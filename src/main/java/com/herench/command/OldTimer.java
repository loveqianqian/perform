    ...
    public void schedule() {
        try {
            ...
            TimerTask timerTask = new TimerTask() {
                ...
                private int count = TimeUtils.getRealGap("2017-10-31");//从后一天开始
                ...
                public void run() {
                    ...
                    if (count == TimeUtils.getRealGap("2017-12-4")) {//到这天结束
            ...
            timer.schedule(timerTask, TimeUtils.getDelay("2017-12-6 0:30:00"), 1000L * 25L);
        } catch (Exception e) {
            e.printStackTrace();
